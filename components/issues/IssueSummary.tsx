...
const statusConfig: Record<IssueStatus, { label: string; bg: string; text: string; border: string }> = {
  '待处理': { label: '待处理', bg: 'bg-red-50', text: 'text-red-700', border: 'border-red-200' },
  '处理中': { label: '处理中', bg: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
  '已解决': { label: '已解决', bg: 'bg-green-50', text: 'text-green-700', border: 'border-green-200' },
  '已关闭': { label: '已关闭', bg: 'bg-gray-50', text: 'text-gray-600', border: 'border-gray-200' },
  '已驳回': { label: '已驳回', bg: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200' },
}
